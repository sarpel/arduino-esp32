...
// Compile-time check to ensure WAVHeader struct is exactly 44 bytes
...
public:
    ...
    // Static utility function for building WAV headers
    static void buildWAVHeader(WAVHeader &header, uint32_t sample_rate,
